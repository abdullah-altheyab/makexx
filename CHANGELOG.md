...
- **Seeds are now clearly highlighted** — a vivid magenta border + glow halo (drawn on top), replacing the easy-to-miss thin white outline. Applies to both pattern/tag matches and double-clicked seeds; the seed chips share the colour.
